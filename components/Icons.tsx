...
export const SwitchCameraIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M20 10c0-4.418-3.582-8-8-8s-8 3.582-8 8c0 1.332.325 2.587.902 3.694L4 12h5v5l-1.414-1.414C6.415 14.42 5 12.37 5 10c0-3.866 3.134-7 7-7s7 3.134 7 7-3.134 7-7 7c-1.118 0-2.176-.272-3.115-.753l-1.47 1.47C8.742 17.786 10.3 19 12 19c4.418 0 8-3.582 8-8z"/>
  </svg>
);
...
export const FaceScanIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M7 17c1.5-2 3-2.5 5-2.5s3.5.5 5 2.5"/>
  </svg>
);
